...
// go get github.com/TikTokTechImmersion/assignment_demo_2023/rpc-server/kitex_gen/rpc
import (
	"context"
	"fmt"
	"strings"
...
// getRoomID to ensure all messages between 2 users are extracted
func getRoomID(chat string) (string, error) {
	...
	// Reordering - Compare the sender and receiver alphabetically, and sort them asc to form the room ID
